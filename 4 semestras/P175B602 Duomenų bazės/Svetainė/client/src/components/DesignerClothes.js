...
import { deleteDesignerClothing, updateDesignerClothing } from '../store/actions/designerClothes';
...
function DesignerClothes({ styles, providers, index }) {
      ...
      <Card elevation={4}>
        <CardContent>
          <Grid container direction={'row'} alignItems={'center'}>
            ...
            <Grid item>
              <IconButton onClick={() => dispatch(deleteDesignerClothing(index))}>
                <ClearIcon />
              </IconButton>
            </Grid>
          </Grid>
